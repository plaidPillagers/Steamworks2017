...
public class Shooter extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
     ...
     public boolean done(){
    	 ...
    	 if(rotation.onTarget() || Math.abs(targetValue-enc)<500){
     ...
     public void readTalonEncoder(){
    	/*int shooterPosition = shooter.getEncPosition();
    	String os =Integer.toString(shooterPosition);
    	SmartDashboard.putString("Shooter Position", os);*/
